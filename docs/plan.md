...
| ~~**JDFN `problem_solving`**~~ | ✅ **LARGELY CLOSED by the re-baseline that landed 2026-09-12** — measured 2026-09-15 at **101.7%** (486/478), down from 233.1%. **8 drafts** still fabricate it; 3 drop `relationships` and 3 drop `decision_making`. Small enough to name individually — repair scoped, not with another ~20-hour pass. See HANDOFF. |
