...
| **MVP-1** | **Core: finish Track P** | nothing — start now | ✅ **P3b is DONE** and produced a defect like the two audits before it — **726 CUPE departments the archive states and the Bank does not** (§9). ✅ **P3d's measurement is DONE too** — scoped to the parser's reading it is ONE unregistered label, ~667 of 680 (§9g). Now **P3d's fix**, **P3e**, **P3f**, then **P3c**. (P4 moved up to MVP-0 — it is drafts, and it is unblocked.) E1 depends on `department` being trustworthy, and it is now measurably not — see the note below. |
