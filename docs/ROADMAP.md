...
> ~~P0.0 navigability~~ ✅ **DONE (PR [#88](https://github.com/humanaxiom/jd-assistant/pull/88))**
> → **P0.3 deployment origins** → **P0.1b-ii** → **P1.3 tier the register**
> (worth promoting) → **P1.2 harmonization provenance**. The HR docs behind all of this
> merged first as [#86](https://github.com/humanaxiom/jd-assistant/pull/86).
> ⚠️ The running stack's CAS origin points at
