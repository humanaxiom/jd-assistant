...
> → **🔴 P0.4 — the production posture, actually in force** (promoted from P0.1b-ii)
> → **P0.1b-ii, the rest** → **P1.3 tier the register** (worth promoting)
