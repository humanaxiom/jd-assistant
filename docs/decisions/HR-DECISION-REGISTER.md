...
Rulebook version `jd_rules_sfu_v4+67decdb6e9d3` · **122 decisions** (122 open · 0 ratified · 0 deferred) · 59 parameters explicitly exempted as trivial · 177 parameters on the decision surface, all accounted for.
