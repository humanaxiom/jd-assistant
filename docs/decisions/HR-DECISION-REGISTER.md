...
| [HR-114](#hr-114) | What counts as a position ID in a filename? | `(?<![0-9])(0[0-9]{7})(?![0-9])` | our invention |
| [HR-115](#hr-115) | How is a file's date read out of its name? | `^((?:19|20)\d{2})(\d{2})(\d{2})` | our invention |
