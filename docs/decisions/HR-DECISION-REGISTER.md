...
Rulebook version `jd_rules_sfu_v4+76baba29cfeb` · **212 decisions** (212 open · 0 ratified · 0 deferred) · 65 parameters explicitly exempted as trivial · 272 parameters on the decision surface, all accounted for.

**Of those 212, 77 need an HR ruling.** The other 135 are recorded for the same build check but are not yours to sign: 50 shape what a reviewer sees without deciding whether a job description passes, and 85 are engineering settings. **Read *Your decisions* below and you have read the ask.**
