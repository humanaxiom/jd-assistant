...
class CanonicalProducerResult(BaseModel):
    ...
    #: ``employee_group == cupe`` proxy really is a WJQ questionnaire.
    ...
    # --- what the producer did, per JDFN cluster ---
    #: JDFN clusters the run entered (persisted + refreshed + skipped + failed).
